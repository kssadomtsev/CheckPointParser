...
def run_parser():
    ...
    while True:
        ...
        if option == "1":
            ...
            policy_worker.create_list_security_policy(config.xml_policy_file, 'security_policy')
            policy_worker.create_list_security_policy(config.xml_policy_file, 'global_policy')
        elif option == "2":
